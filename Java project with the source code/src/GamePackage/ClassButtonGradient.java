...
public class ClassButtonGradient extends JButton {
    ...
    private Color color1 = Color.decode("#654ea3");
    private Color color2 = Color.decode("#eaafc8");
    ...
    private void createStyle(Graphics2D g2){
        ...
        int width = getWidth();
        int height = getHeight();
        GradientPaint gra = new GradientPaint(0,0,Color.WHITE,0,height,new Color(255,255,60));
        g2.setPaint(gra);
        Path2D.Float f = new Path2D.Float();
        f.moveTo(0,0);
        int control1 = height + height/8;
